...
public class StudentListone extends ArrayAdapter<Student> {

    private Activity context;
    private List<Student> studentList;

    public StudentListone(Activity context, List<Student> studentList) {
...
/**        final String course =  textViewcourse.getText().toString();
        ...
        textViewtimecls.setText("SmartCartID: "+student.getKelastimesave());
